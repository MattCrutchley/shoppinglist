...
Please click [here](https://github.com/MattCrutchley/shoppinglist/blob/mulitilist/images/CI_pipeline.png) for a higher resolution image

![CI pipeline](https://github.com/MattCrutchley/shoppinglist/blob/mulitilist/images/CI_pipeline.png)
